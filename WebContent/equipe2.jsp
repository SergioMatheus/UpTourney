...
<body>
	<div class="container">
		...
		<!--
		 ...
		 -->
		<p>Menu dessa equipe: </p>
		<c:if test="${player.login != null }">
			<div class="form-group">
							<ul>
								<li><a href="#"> Nome Equipe : <c:out value="${equipeEscolhida.nomeEquipe}"></c:out></a><li>
								
								<li><a href="#"> ID Equipe 2 : <c:out value="${equipeEscolhida.id}"></c:out></a><li>
								</ul>
			</div>
		</c:if>		
