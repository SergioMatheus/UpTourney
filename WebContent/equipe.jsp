			...
			<div class="form-group">
					<c:forEach var="x" items="${eqp.listarEquipes()}">
							<ul>
								...
								<li><a href="#"> ID Equipe: <c:out value="${x.id}"></c:out></a><li>
								<form id="equipeform" method="post" class="form-horizontal" action="GetEquipeController">
                                	        <input type="hidden" name="codigo" value="${x.id}"/>
