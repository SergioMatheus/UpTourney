		...
		<div class="container">
			...
			<div class="collapse navbar-collapse"
				...
				<ul class="nav navbar-nav">
					...
					<li><a href="equipe.jsp">Equipes</a></li>
					<li><a href="organizacao.jsp">Organização</a></li>
					<li><a href="suporte.jsp">Suporte</a></li>
					<c:if test="${player.login != null }">
						<li><a href="usuariobd.jsp">Meus Dados</a></li>
					</c:if>
					<c:if test="${player.login == null }">
						<li><a href="login.jsp">Login/Cadastro</a></li>
					</c:if>
	...
	<div class="container">
		...
		<div class="row text-center">
			...
			<div class="col-md-3 col-sm-6 hero-feature">
				<div class="thumbnail">
					...
					<div class="caption">
						...
						<p>
							<a href="copalol.jsp" class="btn btn-primary">Participar Agora!</a> 
						</p>
					</div>
				</div>
			</div>
			...
			<div class="col-md-3 col-sm-6 hero-feature">
				<div class="thumbnail">
					...
					<div class="caption">
						...
						<p>
							<font face="Courier New" color="Red">Data:31/02/2052</font> <font
								face="Courier New" color="Red">Premiação: <br>R$500 em dinheiro.
							</font>
						</p>
						<p>
							<a href="copah1z1.jsp" class="btn btn-primary">Participar Agora!</a> 
						</p>
					</div>
				</div>
			</div>
			...
			<div class="col-md-3 col-sm-6 hero-feature">
				<div class="thumbnail">
					<img
						src="https://overwatch-a.akamaihd.net/img/logos/overwatch-share-3d5a268515283007bdf3452e877adac466d579f4b44abbd05aa0a98aba582eeaebc4541f1154e57ec5a43693345bebda953381a7b75b58adbd29d3f3eb439ad2.jpg">
					<div class="caption">
						...
						<p>
							<a href="copaover.jsp" class="btn btn-primary">Participar Agora!</a> 
						</p>
					</div>
				</div>
			</div>
			...
			<div class="col-md-3 col-sm-6 hero-feature">
				<div class="thumbnail">
					<img src="http://fraghero.com/wp-content/uploads/2016/07/csgogamblingcover.jpg">
					<div class="caption">
						...
						<p>
							<a href="copacs.jsp" class="btn btn-primary">Participar Agora!</a>
						</p>
					</div>
				</div>
			</div>
